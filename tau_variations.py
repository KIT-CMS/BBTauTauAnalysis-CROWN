...
def add_tau_id_vs_jet_shifts(
    ...
    if era in ERAS_RUN2 + [
        ...
        shifts = _get_run2_2022_2023_tau_id_vs_jet_shifts(
            era,
            tau_id_algorithm=tau_id_algorithm,
        )
    elif era in ["2024", "2025"]:
        shifts = _get_2024_2025_tau_id_vs_jet_shifts(
            era,
            tau_id_algorithm=tau_id_algorithm,
        )
    else:
...
def add_tau_id_vs_e_shifts(
    ...
    # decorrelated between the 2D bins in DM x (barrel, endcap).
    shifts = [
        {
